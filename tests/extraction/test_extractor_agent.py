...
def test_extractor_agent_extracts_event(
    metacog_logger: Metacog, mock_llm: MockLLMService
):
...
def test_extractor_agent_handles_validation_error(
    metacog_logger: Metacog, mock_llm: MockLLMService
):
